...
String modelMovieDetailToJson(ModelMovieDetail data) => json.encode(data.toJson());
...
class ModelMovieDetail {
  ...
  Map<String, dynamic> toJson() => {
    ...
    "belongs_to_collection": belongsToCollection == null ? null : belongsToCollection!.toJson(),
